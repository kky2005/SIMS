<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnrolledCourses.aspx.cs" Inherits="SIMS.Student.EnrolledCourses" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SIMS - Enrolled Courses</title>
        ...
        <div class="container-sims">
            ...
            <div class="card-sims">
                <div class="card-header-sims">
                    ...
                    <p>View your current enrolled courses and access lecturer materials.</p>
                    <asp:Label ID="lblMessage" runat="server" CssClass="message"></asp:Label>
                </div>

                <div class="card-body-sims">
                    <div class="note-box">
                        Select a course to view course details and download materials uploaded by your lecturer.
                    </div>

                    <asp:GridView ID="gvEnrolledCourses" runat="server"
                        AutoGenerateColumns="False"
                        CssClass="grid"
                        EmptyDataText="No active enrolled courses found."
