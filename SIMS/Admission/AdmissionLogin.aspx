<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="AdmissionLogin.aspx.cs"
    Inherits="SIMS.AdmissionLogin" %>
...
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-left { background: linear-gradient(135deg, #ea7e66 0%, #a24b76 100%); color: white; padding: 60px 40px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; }
        ...
        <div class="login-right">
            ...
            <form runat="server">
                ...
                <div class="form-group">
                    <label for="txtEmail">Email or User ID</label>
                    <asp:TextBox ID="txtEmail" runat="server" placeholder="Enter your email or User ID" TextMode="SingleLine" />
                    <asp:RequiredFieldValidator ID="rfvLoginEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Please enter your email or User ID." CssClass="field-error" Display="Dynamic" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvLoginPassword" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please enter your password." CssClass="field-error" Display="Dynamic" />
                </div>
